...
class CXRDataset(data.Dataset): 
    ...
    def __init__(self, data_path,
                 input_transform=None, used_category=-1, train=True):
        ...
        self.df = self.df.loc[:, cate + ['0_IMAGEINDEXORPATH']] #tengo solo le colonne delle findings che voglio più una colonna per il filename o path
        self.df.sort_index(axis=1, inplace=True) #lo devo ordinare per colonna alfabetica
