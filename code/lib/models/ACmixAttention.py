...
class ACmix(nn.Module):
    ...
    def forward(self, x):
        ...
        except RuntimeError as e: #TODO Added by me
            if 'out of memory' in str(e):
                print('| Gianluca WARNING: ran out of memory, retrying forward of ACmixAttention!')
                
                if att.grad is not None:
                    del att.grad  # free some memory
                if out_att.grad is not None:
                    del out_att.grad  # free some memory
